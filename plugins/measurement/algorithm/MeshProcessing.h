...
namespace plugin{
    ...
    void writePartialMesh(indicesTriMesh<glm::vec3> mesh, std::vector<glm::ivec3>&& faces, std::string file_name);
    void writePartialMesh(indicesTriMesh<glm::vec3> mesh, std::vector<glm::ivec2>&& line, std::string file_name);
    void writePartialMesh(indicesTriMesh<glm::vec3> mesh, std::vector<glm::ivec2>&& line, std::fstream fileHandle);
    void writeSlices(indicesTriMesh<glm::vec3> mesh, sliceContour&& slices, std::string file_name);
